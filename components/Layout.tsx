      ...
      <aside className="w-20 lg:w-64 flex flex-col bg-gray-900/50 backdrop-blur-md border-r border-studio-accent z-20 shadow-2xl transition-all duration-300">
        <div className="h-24 flex items-center justify-center border-b border-studio-accent p-2">
          ...
          >
            ...
            <span
              id="fallback-logo"
              className="hidden text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-neon-purple to-neon-cyan"
            >
              4us!
            </span>
          </button>
            ...
            {NAV_ITEMS.map((item) => (
              <li key={item.id}>
                ...
                >
                  ...
                  <span className="hidden lg:block ml-4 font-medium">
                    {item.label}
                  </span>
                </button>
              </li>
